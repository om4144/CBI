    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try (Connection conn = Database.getConnection()) {
            ...
            html.append("<div class='card'><h3>Manage Funds</h3>")
                ...
                .append("<label>Action</label><select name='action'><option value='add'>Add Money</option><option value='withdraw'>Withdraw</option></select>")
            ...
            double monthlyInvest = 0; // New Variable for Investments
            ...
            while(rsHist.next()) {
                ...
                if (date.getMonth() == currentMonth) {
                    if (type.equals("DEPOSIT") || type.equals("RECEIVED")) {
                        ...
                        monthlyInvest += amount; // Separate Investment
                    } 
                    else {
                ...
                String color = (type.equals("DEPOSIT") || type.equals("RECEIVED")) ? "green" : "red";
            ...
            html.append("<script>")
                ...
                .append("    data: {")
                .append("        labels: ['Income', 'Spending', 'Investments'],") // 3 Labels
                .append("        datasets: [{")
                .append("            data: [").append(monthlyIncome).append(", ").append(monthlyExpense).append(", ").append(monthlyInvest).append("],") // 3 Values
                .append("            backgroundColor: ['#2ecc71', '#e74c3c', '#e67e22'],") // Green, Red, Orange
